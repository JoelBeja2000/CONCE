...
/**
 * REST controller for managing {@link com.concesionariopepe.com.domain.CompraVenta}.
 */
@RestController
@RequestMapping("/api")
public class CompraVentaResource {
    ...
    public ResponseEntity<CompraVenta> updateCompraVenta(@RequestBody CompraVenta compraVenta) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, compraVenta.getId().toString()))
            .body(result);
    }
