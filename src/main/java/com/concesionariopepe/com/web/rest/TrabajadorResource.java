...
/**
 * REST controller for managing {@link com.concesionariopepe.com.domain.Trabajador}.
 */
@RestController
@RequestMapping("/api")
public class TrabajadorResource {
    ...
    public ResponseEntity<Trabajador> updateTrabajador(@RequestBody Trabajador trabajador) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, trabajador.getId().toString()))
            .body(result);
    }
